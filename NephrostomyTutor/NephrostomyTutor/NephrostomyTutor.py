...
class NephrostomyTutorGuidelet(Guidelet):
  ...
  def setupStepsLayouts(self):
    ...
    self.initialScanCheckBox = qt.QCheckBox("\tScan kidney medially to laterally")
    self.identifyTargetLocationCheckBox = qt.QCheckBox("\tIdentify target calyx")

    self.applyLocalAnestheticCheckBox = qt.QCheckBox("\tApply local anesthetic")

    self.IdentifyCheckBox = qt.QCheckBox("\tDetermine puncture site")

    #self.scanVesselCrossSection2CheckBox = qt.QCheckBox("\tScan vessel cross section")
    self.insertNeedleCheckBox = qt.QCheckBox("\tInsert needle into calyx using needle guide")
    self.makeIncisionCheckBox = qt.QCheckBox("\tMake incision using trocar")

    self.removeNeedleStellateCheckBox = qt.QCheckBox("\tRemove needle stellate")

    self.PunctureCalyxCheckBox = qt.QCheckBox("\tPuncture Calyx")

    self.insertGuidewireCheckBox = qt.QCheckBox("\tInsert guidewire")
    self.GuidewireCheckBox = qt.QCheckBox("\tGuidewire")

    self.inciseTractCheckBox = qt.QCheckBox("\tSlide scalpel over needle until \n\t\t\t\tdorsolumbar fascia incised")
    self.inciseTractCheckBox.setMinimumSize(200, 60)
    ...
    self.dilateTractCheckBox = qt.QCheckBox("\tThread dilator over guidewire and\n\t\t\t\t into tissue using rotary screw motion")
    self.dilateTractCheckBox.setMinimumSize(200, 60)

    self.removeDilatorCheckBox = qt.QCheckBox("\tRemove dilator")
    self.DilateCheckBox = qt.QCheckBox("\tTract dilation")

    self.threadCatheterCheckBox = qt.QCheckBox("\tThread nephrostomy over guidewire")

    self.CatheterCheckBox = qt.QCheckBox("\tNephrostomy")
    ...
    self.StepsLayout.addWidget(self.initialScanCheckBox)
    self.StepsLayout.addWidget(self.identifyTargetLocationCheckBox)
    self.StepsLayout.addWidget(self.applyLocalAnestheticCheckBox)
    self.StepsLayout.addWidget(self.IdentifyCheckBox)
    self.StepsLayout.addWidget(self.makeIncisionCheckBox)
    self.StepsLayout.addWidget(self.insertNeedleCheckBox)
    self.StepsLayout.addWidget(self.removeNeedleStellateCheckBox)
    self.StepsLayout.addWidget(self.PunctureCalyxCheckBox)
    self.StepsLayout.addWidget(self.insertGuidewireCheckBox)
    self.StepsLayout.addWidget(self.GuidewireCheckBox)
    self.StepsLayout.addWidget(self.inciseTractCheckBox)
    self.StepsLayout.addWidget(self.RemoveNeedleCheckBox)
    self.StepsLayout.addWidget(self.dilateTractCheckBox)
    self.StepsLayout.addWidget(self.removeDilatorCheckBox)
    self.StepsLayout.addWidget(self.DilateCheckBox)
  ...
  def hideBeginnerSteps(self):
    self.IdentifyCheckBox.visible = True
    self.PunctureCalyxCheckBox.visible = True
    self.GuidewireCheckBox.visible = True
    self.DilateCheckBox.visible = True
    self.CatheterCheckBox.visible = True

    self.initialScanCheckBox.visible = False
    self.identifyTargetLocationCheckBox.visible = False
    ...
    self.removeNeedleStellateCheckBox.visible = False
    self.insertGuidewireCheckBox.visible = False
    self.inciseTractCheckBox.visible = False
    self.RemoveNeedleCheckBox.visible = False
    self.dilateTractCheckBox.visible = False
  ...
  def hideIntermediateSteps(self):
    self.IdentifyCheckBox.visible = False
    self.PunctureCalyxCheckBox.visible = False
    self.GuidewireCheckBox.visible = False
    self.DilateCheckBox.visible = False
    self.CatheterCheckBox.visible = False

    self.initialScanCheckBox.visible = True
    self.identifyTargetLocationCheckBox.visible = True
    ...
    self.removeNeedleStellateCheckBox.visible = True
    self.insertGuidewireCheckBox.visible = True
    self.inciseTractCheckBox.visible = True
    self.RemoveNeedleCheckBox.visible = True
    self.dilateTractCheckBox.visible = True
