...
START /MIN C:\Users\perkl\PlusApp-2.8.0.20191105-Telemed-Win32\bin\PlusServerLauncher.exe --connect --device-set-configuration-dir="C:\D\NephrostomyTutor-main\Config" --config-file=Telemed-60mm-L12_Ascension.xml
